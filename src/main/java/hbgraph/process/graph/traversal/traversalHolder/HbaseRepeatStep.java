...
public class HbaseRepeatStep<S> extends ComputerAwareStep<S, S> implements TraversalHolder<S, S> {

    public HbaseRepeatStep(Traversal traversal, RepeatStep<S> originalStep)
    {
        super(traversal);
    ...
    @Override
    public HbaseRepeatStep<S> clone() throws CloneNotSupportedException {
        final HbaseRepeatStep<S> clone = (HbaseRepeatStep<S>) super.clone();
        return clone;
    }
